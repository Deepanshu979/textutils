...
export default function TextForm(props) {
  ...
  return (
    ...
    <div>
        ...
        <button className="btn btn-primary mx-2 my-3" diabled={text.length===0} onClick={handleUpClick}>Convert to Uppercase</button>
        <button className="btn btn-primary mx-2 my-3" diabled={text.length===0} onClick={handleLoClick}>Convert to Lowercase</button>
        </div>
    </div>
    </div>
